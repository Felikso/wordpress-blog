...
export const SocialMenu = ({ isExpanded }) => {
  const { wpMenu, wpMain } = useStaticQuery(graphql`
    {
  ...
  const socials = wpMain.social_menu

  console.log(Object.keys(socials).map((keyName, i) => console.log(socials[keyName])))
