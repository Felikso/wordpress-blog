...
export const CustomedFooter = () => {
    ...
    const { wpRef } = useStaticQuery(graphql`
    {
        wpRef(slug: {eq: "core-links"}) {
        social_menu_footer {
          facebook
          instagram
          phone
  ...
  `)
    ...
    if (!wpRef?.social_menu_footer || wpRef.social_menu_footer === 0) return null

    const socials = wpRef.social_menu_footer

    const info = wpRef.footer_info
